...
function CourseCard({ course }) {
    return (
        <div class="max-w-sm w-64 bg-white border border-gray-200 rounded-lg shadow ">
            <Link to="#">
                <img class="rounded-t-lg" src={course.image} className='h-56 w-full object-cover' alt="" />
            </Link>
            <div class="p-5">
                <Link to="#">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{course.rating}</p>
