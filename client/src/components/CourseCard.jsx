...
function CourseCard({id,name,description,img,rating}) {
    ...
    return (
        <div className="shadow-lg card w-96 h-[600px] bg-base-100">
            ...
            <div className="card-body">
                ...
                <div className='flex items-center gap-1 mt-auto text-xl font-bold'>{rating}<MdStar className='text-2xl text-primary'/></div>
                <div className="mt-3 card-actions">
                    <button onClick={()=>{navigate(`/courses/course/${id}`)}} className="w-full rounded-full btn btn-primary">Explore</button>
                </div>
            </div>
        </div>
    )
